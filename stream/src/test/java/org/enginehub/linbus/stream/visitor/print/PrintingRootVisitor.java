...
public class PrintingRootVisitor extends PrintingVisitor implements LinRootVisitor {
    public PrintingRootVisitor() {
        super("root");
    }
    ...
    public LinCompoundTagVisitor visitValue(String name) {
        print(name);
        return new PrintingCompoundTagVisitor(nest(name));
    }
}
